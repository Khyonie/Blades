...
public class PBS_attack_light_3 extends PlayerBladeSpecial 
{
    public PBS_attack_light_3() 
    {
        super("HeavenCall", "Heaven's call", "Launches the target high into the air.", Element.LIGHT, Role.ATTACK);
    }
